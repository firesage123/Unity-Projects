...
public class PlayerControl : MonoBehaviour {
    ...
    internal void FixedUpdate() {
        ...
        // Drag
        Vector3 forDrag = Mathf.Sign(vf)*ForwardDragCoefficient*vf*vf*transform.forward;
        playerRB.AddForce(forDrag);
        
        float vup = Vector3.Dot(vrel, transform.up);
        Vector3 vDrag = Mathf.Sign(vup)*VerticalDragCoefficient*vup*vup*transform.up;
